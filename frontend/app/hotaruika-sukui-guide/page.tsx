      ...
      <Card className="max-w-4xl mx-auto bg-card/80 backdrop-blur-sm border-blue-400/20">
        ...
        <CardContent className="space-y-12 text-sm md:text-lg leading-7 md:leading-relaxed text-foreground/90">
          ...
          <nav aria-label="目次" className="bg-muted/50 p-5 rounded-lg border border-blue-400/10">
            <h2 className="text-base md:text-lg font-semibold text-blue-300 mb-3">目次</h2>
          ...
          <section id="biology" className="scroll-mt-20">
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-4 mb-2">基本データ</h3>
            <ul className="list-none space-y-2 bg-muted/40 p-5 rounded-lg border border-blue-400/10">
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-6 mb-2">3種類の発光器</h3>
            <p>
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-6 mb-2">1年の一生</h3>
            <p>
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-6 mb-2">なぜ富山湾なのか</h3>
            <p>
          ...
          <section id="monthly-trend" className="scroll-mt-20">
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-6 mb-2">月別の傾向</h3>
          ...
          <section id="conditions" className="scroll-mt-20">
            ...
            <ul className="list-none mt-4 space-y-3 bg-muted/50 p-6 rounded-lg border border-blue-400/10">
          ...
          <section id="tips" className="scroll-mt-20">
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-6 mb-2">よくある失敗</h3>
          ...
          <section id="preparation" className="scroll-mt-20">
            ...
            <h3 className="text-base md:text-xl font-semibold text-purple-300 mt-4 mb-2">持ち帰りの基本</h3>
            <p>
            ...
            <div className="bg-muted/50 p-5 rounded-lg border border-pink-400/30 mt-6">
              ...
              <p className="text-sm mt-3">
                家庭用冷凍庫は-18℃前後しかないため、生食処理には不十分です。生食したい場合は処理済みのものを購入してください。
              </p>
            </div>
          </section>
          ...
          <div className="bg-muted/50 p-6 rounded-lg border border-blue-400/10 text-center">
            <p className="text-sm text-foreground/80">
              当サイトでは、ホタルイカが湧きやすい条件をAIで分析した湧き予測を毎日提供しています。
            </p>
